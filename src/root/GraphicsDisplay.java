...
/*    private double minX1;
    ...
    public GraphicsDisplay()
    {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, new float[] {10, 10}, 0.0f);
    ...
    protected void paintAxis(Graphics2D canvas)
    {
        ...
        if (selectedMarker >= 0)
        {
            ...
            Point2D.Double point = xyToPoint(((Double[])graphicsData.get(selectedMarker))[0].doubleValue(), ((Double[])graphicsData.get(selectedMarker))[1].doubleValue());
